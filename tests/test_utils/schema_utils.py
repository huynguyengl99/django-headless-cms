"""This module is copied from drf spectacular test utils. See more at: https://github.dev/tfranzel/drf-spectacular"""
...
def assert_api_schema(api_schema, reference_filename):
    reference_filename = build_absolute_file_path(reference_filename)
